## 4.12.0
  - Feat: Update Elasticsearch client to 7.14.0 to handle unsupported products [#157](https://github.com/logstash-plugins/logstash-filter-elasticsearch/pull/157)
